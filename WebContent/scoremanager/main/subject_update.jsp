	...
	<c:param name="content">
		<section class="me-4">
			...
			<form method="post" action="SubjectUpdateExecute.action">
				<input type="hidden" name="code" value="${subject.getCode()}">

				<div class="mb-2 mx-2">
					<label class="form-label" for="subject-code">科目コード</label>
					<input type="text" id="subject-code" class="form-control" name="code"
						value="${subject.getCode()}" disabled>
				</div>
				<div class="mb-2 mx-2">
					<label class="form-label" for="subject-name">科目名</label>
					<input type="text" id="subject-name" class="form-control" name="name" required
						maxlength="50" placeholder="科目名を入力してください" value="${subject.getName()}">
				</div>
